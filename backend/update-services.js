...
async function updateServices() {
  ...
  try {
    ...
    // First, clear any bookings that reference services
    ...
    for (const service of services) {
      await client.query(insertQuery, service);
    }
    
    console.log(`✅ Inserted ${services.length} comprehensive salon services`);
